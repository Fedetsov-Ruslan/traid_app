...
Revision ID: 70a648f67d87
Revises: d3fc83a369fc
Create Date: 2024-07-04 17:57:38.679439
...
revision: str = '70a648f67d87'
down_revision: Union[str, None] = 'd3fc83a369fc'
...
def downgrade() -> None:
    ...
    sa.Column('permishions', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True),
    ...
    sa.Column('registrete_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
